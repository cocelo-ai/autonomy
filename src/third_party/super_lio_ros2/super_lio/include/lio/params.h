...
namespace LI2Sup{
  ...
  extern double g_slam_accumulation_interval_sec;
  ...
  extern bool g_publish_path;
  extern int  g_pub_step;
  extern double g_tf_publish_rate_hz;
  extern bool g_elevation_enable;
  extern float g_elevation_radius;
  extern float g_elevation_leaf_size;
  extern double g_elevation_publish_rate_hz;
