...
namespace LI2Sup{
  ...
  double g_slam_accumulation_interval_sec = 0.1;
  ...
  bool g_elevation_enable = true;
  float g_elevation_radius = 3.0f;
  float g_elevation_leaf_size = 0.10f;
  double g_elevation_publish_rate_hz = 5.0;
