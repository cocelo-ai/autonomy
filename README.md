...
실기 elevation mapping은 자체 구현 대신 `third_party/elevation_mapping`의
ETH/ANYbotics robot-centric pipeline을 사용한다. 이 저장소의 코드 역할은
Livox·Super-LIO·elevation mapping을 짧고 재현 가능하게 기동하는 bringup뿐이다.
...
50 Hz publish다. 주요 layer는 다음과 같다.
