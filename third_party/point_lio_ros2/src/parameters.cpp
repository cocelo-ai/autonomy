...
std::vector<double> odom_child_to_body_T;
std::vector<double> odom_child_to_body_R;
std::vector<double> odom_output_correction_T;
std::vector<double> odom_output_correction_R;
...
bool map_update_floor_gate_en = true;
double map_update_floor_gate_radius = 0.6;
double map_update_floor_gate_percentile = 0.20;
int map_update_floor_gate_min_points = 30;
double map_update_floor_gate_max_jump = 0.08;
double map_update_floor_gate_stable_band = 0.03;
int map_update_floor_gate_stable_frames = 8;
int map_update_floor_gate_skip_frames_after_jump = 12;
bool map_update_floor_gate_reset_map_after_jump = true;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<std::vector<double>>("odom.child_to_body_T", {0, 0, 0});
    nh->declare_parameter<std::vector<double>>("odom.child_to_body_R", {1, 0, 0, 0, 1, 0, 0, 0, 1});
    nh->declare_parameter<std::vector<double>>("odom.output_correction_T", {0, 0, 0});
    nh->declare_parameter<std::vector<double>>("odom.output_correction_R", {1, 0, 0, 0, 1, 0, 0, 0, 1});
    ...
    nh->declare_parameter<double>("publish.local_map_z_length", 3.0);
    nh->declare_parameter<int>("publish.local_map_every_n_frames", 1);
    nh->declare_parameter<bool>("mapping.map_update_floor_gate.enabled", true);
    nh->declare_parameter<double>("mapping.map_update_floor_gate.radius", 0.6);
    nh->declare_parameter<double>("mapping.map_update_floor_gate.percentile", 0.20);
    nh->declare_parameter<int>("mapping.map_update_floor_gate.min_points", 30);
    nh->declare_parameter<double>("mapping.map_update_floor_gate.max_jump", 0.08);
    nh->declare_parameter<double>("mapping.map_update_floor_gate.stable_band", 0.03);
    nh->declare_parameter<int>("mapping.map_update_floor_gate.stable_frames", 8);
    nh->declare_parameter<int>("mapping.map_update_floor_gate.skip_frames_after_jump", 12);
    nh->declare_parameter<bool>("mapping.map_update_floor_gate.reset_map_after_jump", true);
    ...
    nh->get_parameter("odom.child_to_body_T", odom_child_to_body_T);
    nh->get_parameter("odom.child_to_body_R", odom_child_to_body_R);
    nh->get_parameter("odom.output_correction_T", odom_output_correction_T);
    nh->get_parameter("odom.output_correction_R", odom_output_correction_R);
    ...
    nh->get_parameter("publish.local_map_topic", local_map_topic);
    nh->get_parameter("publish.local_map_x_length", local_map_x_length);
    nh->get_parameter("publish.local_map_y_length", local_map_y_length);
    nh->get_parameter("publish.local_map_z_length", local_map_z_length);
    nh->get_parameter("publish.local_map_every_n_frames", local_map_publish_every_n_frames);
    nh->get_parameter("mapping.map_update_floor_gate.enabled", map_update_floor_gate_en);
    nh->get_parameter("mapping.map_update_floor_gate.radius", map_update_floor_gate_radius);
    nh->get_parameter("mapping.map_update_floor_gate.percentile", map_update_floor_gate_percentile);
    nh->get_parameter("mapping.map_update_floor_gate.min_points", map_update_floor_gate_min_points);
    nh->get_parameter("mapping.map_update_floor_gate.max_jump", map_update_floor_gate_max_jump);
    nh->get_parameter("mapping.map_update_floor_gate.stable_band", map_update_floor_gate_stable_band);
    nh->get_parameter("mapping.map_update_floor_gate.stable_frames", map_update_floor_gate_stable_frames);
    nh->get_parameter("mapping.map_update_floor_gate.skip_frames_after_jump", map_update_floor_gate_skip_frames_after_jump);
    nh->get_parameter("mapping.map_update_floor_gate.reset_map_after_jump", map_update_floor_gate_reset_map_after_jump);
