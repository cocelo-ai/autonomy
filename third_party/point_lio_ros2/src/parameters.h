...
extern int init_map_size, con_frame_num, max_lidar_buffer_size;
extern int path_publish_stride, max_path_pose_count;
...
extern std::string pcd_save_file;
