...
What it does:
  ...
  3. Links this repo's src/third_party/livox_ros_driver2 into <workspace>/src/livox_ros_driver2.
...
install_livox_sdk2() {
  ...
  local sdk_dir="${PACKAGE_DIR}/src/third_party/Livox-SDK2"
...
prepare_vendored_driver() {
  local driver_dir="${PACKAGE_DIR}/src/third_party/livox_ros_driver2"
...
Next:
  ...
  ${PACKAGE_DIR}/scripts/launch.sh --real --mid360
EOF
